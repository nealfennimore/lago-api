...
module PaymentProviderCustomers
  class CreateService < BaseService
    ...
    def create_customer_on_provider_service(async)
      ...
      elsif result.provider_customer.type == 'PaymentProviderCustomers::NowpaymentsCustomer'
        return PaymentProviderCustomers::NowpaymentsCreateJob.perform_later(result.provider_customer) if async

        PaymentProviderCustomers::NowpaymentsCreateJob.perform_now(result.provider_customer)
      else
