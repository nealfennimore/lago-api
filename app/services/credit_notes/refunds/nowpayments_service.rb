  ...
  module Refunds
    class NowpaymentsService < BaseService
      ...
      def create
        ...
        nowpayments_result = create_nowpayments_refund
        ...
        refund = Refund.new(
          ...
          amount_cents: nowpayments_result.response.dig('amount', 'value'),
          amount_currency: nowpayments_result.response.dig('amount', 'currency'),
          status: 'pending',
          provider_refund_id: nowpayments_result.response['pspReference'],
        )
        refund.save!
      ...
      def nowpayments_api_key
        nowpayments_payment_provider.secret_key
      end
      ...
      def handle_missing_refund(metadata)
        ...
        result.not_found_failure!(resource: 'nowpayments_refund')
      end
